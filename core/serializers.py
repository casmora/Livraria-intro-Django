...
class EditoraNestedSerializer(ModelSerializer):
    class Meta:
        model = Editora 
        fields = ('nome',) # só mostrar o campo nome da editora
...
class LivroDetailSerializer(ModelSerializer):
    categoria = CharField(source="categoria.descrição")# usar descri"ÇÂO"
    #editora = EditoraNestedSerializer()#esconder o id de editora  ou mostrar em profundidade
